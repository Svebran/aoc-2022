...
void move_crates(crate layer_bottom[])
{
    ...
    crate* layer_top[stacks], * moving_crate;
    ...
    while(fgets(buffer, 1024, stdin) != NULL)
    {
        ...
        {
            //change crates properties if exist: from - over (1), to - over (2), moving - under (3)
            //change top layer: from (4), to (5)
            moving_crate = layer_top[from];
